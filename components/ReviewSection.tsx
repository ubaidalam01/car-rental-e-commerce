...
function ReviewsSection() {
  ...
  return (
    <section className="bg-gray-100 p-4">
      <h2 className="text-2xl font-bold mb-6">Reviews <span className="text-gray-500">({reviews.length})</span></h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Review</button>
      </form>
    </section>
  );
}
