export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'slug',
      title: 'Slug',
      description: 'Unique identifier for the car (used in URLs)',
      options: {
        source: 'name', // Generates the slug based on the car name
    ...
    },
    {
      ...
      description: 'A short description for the car (visible only on the details page)',
    },
    {
      name: 'fuelCapacity',
      type: 'string',
